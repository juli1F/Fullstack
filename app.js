...
app.get('/tarefas', async (req, res) => { //Select
  try {
...
app.post('/tarefas', async (req, res) => {    //insert
  try {
...
app.put('/tarefas/:id', async (req, res) => { //update
  try {
...
app.delete('/tarefas/:id', async (req, res) => { //delete
  try {
    const id = req.params.id;
